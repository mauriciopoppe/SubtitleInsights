...
interface SubtitleCapturedMessage {
...
const handleSubtitlesCaptured = async (message: SubtitleCapturedMessage) => {
  ...
  if (message.language && config.autoSelectProfile) {
    await ProfileManager.autoSelectProfileByLanguage(message.language)
  }
