...
### Pause on Hover
Hovering over the overlay near the end of a subtitle segment will automatically pause the video. 
...
[Screenshot Placeholder: Overlay proximity controls in action]
...
[Screenshot Placeholder: YouTube-style settings popup]
