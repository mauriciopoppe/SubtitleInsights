...
- [x] Task: Create a new SVG icon for the extension button.
  - [x] Design or source a simple SVG (e.g., "Translate" icon) that fits the YouTube player aesthetic.
- [x] Task: Update `setupToggle` in `src/content/index.ts`.
  ...
  - [x] Update the injection logic to insert _before_ `.ytp-subtitles-button`.
