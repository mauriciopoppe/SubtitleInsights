...
- [x] **Task: Conductor - User Manual Verification 'Store & Logic' (Protocol in workflow.md)**

### Phase 2: UI Component Updates

- [x] **Task: Hover Logic Hook**
  - Implement a custom hook or logic within `SidebarItem` to manage the 2-second hover timer.
- [x] **Task: Sync Icon Injection**
