...
- **Hybrid Auto-Activation & Filtering Logic:**
    - **Trigger:** Automatically generate summaries for sentences identified as N5+ *AND* meet a minimum complexity requirement (e.g., >5 characters OR contains at least 1 particle).
