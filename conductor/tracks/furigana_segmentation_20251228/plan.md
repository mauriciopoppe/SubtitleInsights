...
## Phase 1: AI Prompt Engineering & Data Structure
...
- [ ] Task: Create a rendering function `renderSegmentedText` that takes the AI data and returns an HTML string/fragment using `<ruby>` and spaces.
- [ ] Task: Add basic CSS styles to `src/content/styles.css` to ensure `<ruby>` tags and spaces are legible within the YouTube overlay.
