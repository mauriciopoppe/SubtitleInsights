...
- **Brand Palette:** Adhere to the core color scheme:
  - **Action Blue (`#3ea6ff`):** Trust and structure (Links, buttons, navigation).
  - **Accent Yellow (`#ffd600`):** Urgency and focus (Active segments, warnings).
  - **Canvas Black (`#0f0f0f`):** Main backgrounds.
  - **Neutral White (`#f8fafc`):** Primary text.
...
- **Brand Motto:** "Subtitle data, clarified."
